...
| — | **Checkpoint 2** — sign-up → business → invite → walker accepts, on two devices | [x] | PASS 2026-08-23 (iPhone + simulator, hosted Supabase); steps 6–7 waived — walker sign-out missing, follow-up open |
