...
| — | **Checkpoint 2** — sign-up → business → invite → walker accepts, on two devices | [~] | steps 1–5 pass 2026-08-23 (iPhone + simulator, hosted Supabase); walker sign-out missing → follow-up in `checkpoints.md` |
