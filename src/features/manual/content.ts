  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        kind: 'p',
        text:
          'Assigning works like an offer: when you offer a visit to a walker, they see it on their Today screen and accept or decline. A decline always comes with a reason and puts the visit back in the unassigned pile — which shows up in Needs attention so nothing slips. You can also assign directly when you don’t need the accept step.',
      },
      {
        kind: 'p',
        text:
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          'The walk screen records your route in the background and shows four quick buttons: Pee, Poop, Photo, Note. Each tap is stamped with the time. Feeding, water, or meds go in a note.',
